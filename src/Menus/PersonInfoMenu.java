...
public class PersonInfoMenu extends JPanel{
    ...
    public void generatePanel(){
        ...
        if(w.orderHistory.size() == 0){
            ...
            for (int i = 0; i < w.orderHistory.size(); i++) {
                orderHistoryLabel = new JLabel("Order " + (i + 1) + ": Pizza name: " + w.orderHistory.get(i).getName() + ", Pizza count " + w.orderHistory.get(i).getCount());
                orderHistoryLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
                orderHistoryLabel.setForeground(new Color(187, 134, 252));
